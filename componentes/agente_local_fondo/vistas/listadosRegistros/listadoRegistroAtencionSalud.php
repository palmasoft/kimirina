...
<div id="page-content">
     <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="#">Supervisión</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
    ...
    <?php $this->mostrar("listadosRegistros/tablaListadoRegistrosAtencionSalud", $this->datos); ?>
