...
<div id="pre-page-content">
    <h1>
        <i class="fa-ambulance themed-color"></i> Registro de Eventos Masivos con Referidos Efectivos<br>
...
<!--            <a href="javascript:mostrar_formulario_evento_masivo()" data-toggle="tooltip" title="Editar Formulario" class="btn btn-lg btn-warning"><i class="icon-pencil"></i>Editar</a>
    ...
    <?php $this->mostrar("listadosRegistros/tablaListadoRegistroEventosMasivos", $this->datos); ?>
