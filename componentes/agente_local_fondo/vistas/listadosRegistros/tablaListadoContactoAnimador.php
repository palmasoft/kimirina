        ...
        if (!empty($ContactoAnimador)) {
            foreach ($ContactoAnimador as $contactoAnimador) {
                ...
                <tr fila-id="<?php echo $contactoAnimador->ID_CONTACTOANIMADOR ?>" data-titulo="<?php echo ($contactoAnimador->NO_RECIBO_CONTACTOANIMADOR) ?>">
                    ...
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_ANIMADOR) ?></td>
                    <td class=""><?php echo ($contactoAnimador->NUM_CONDONES . '/' . $contactoAnimador->NUM_LUBRICANTES . '/' . $contactoAnimador->NUM_FOLLETOS) ?></td>
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_MONITOR ) ?></td>      
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_COORDINADOR ) ?></td>      
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_DIGITADOR ) ?> <?php echo ($contactoAnimador->FECHA_CREACION_RECIBO_ANIMADOR ) ?></td>  
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_MODIFICA ) ?> <?php echo ($contactoAnimador->FECHA_MODIFICACION_RECIBO_ANIMADOR ) ?></td> 
                    <td class=""><?php echo ($contactoAnimador->NOMBRE_ELIMINA) ?> <?php echo ($contactoAnimador->FECHA_ELIMINACION_RECIBO_ANIMADOR ) ?></td>
                </tr>
                <?php
            }
        }
