<div > <center> 
        <?php echo ($this->datos['SubReceptor']->ID_SUBRECEPTOR == 0) ? "<h5>SubReceptor: <strong>" . $datosRegistroSemanal->SIGLAS_SUBRECEPTOR . "</strong></h5>" : "" ?>
                ...
                <div class="span6">
                    <div class="control-group">
                        ...
                        <div id="lista-provincia" class="controls">
                            <h4><?php echo ( $datosRegistroSemanal->NOMBRE_PROVINCIA); ?></h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="span6">
                    <div class="control-group">
                        ...
                        <div id="listado-cantones" class="controls">
                            <h4><?php echo ( $datosRegistroSemanal->NOMBRE_CANTON); ?></h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">  
                <div class="span6">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <h4><?php echo ( $datosRegistroSemanal->NOMBRE_REAL_PERSONA); ?></h4>
                        </div>
                    </div>                            
                </div>
                <div class="span3" style="display: none;" >
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <h4><?php echo ( $datosRegistroSemanal->NOMBRE_OTRO_PERSONA); ?></h4>
                        </div>
                    </div>                            
                </div>
                ...
                <div class="span3">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <h4><span class="add-on"><i class="icon-calendar"></i> </span> 
                            <?php echo ( $datosRegistroSemanal->SEMANA_DEL ); ?></h4>
                        </div>
                    </div>
                </div>
                <div class="span3" style="margin-left: 0px;">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <h4><span class="add-on"><i class="icon-calendar"></i> </span> <?php echo ( $datosRegistroSemanal->SEMANA_HASTA); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    if (!empty($datosRegistroSemanal->CONTACTOS)) {
                        foreach ($datosRegistroSemanal->CONTACTOS as $contacto) :
                            ...
                            <tr  style="font-size: 80%; text-align: center;" >
                                <td  style="width: 10px;"><?php echo intval($contacto->ID_REGISTRO_CONTACTO); ?></td>
                                <td><?php echo ( $contacto->FECHA_CONTACTO); ?>&nbsp;<?php echo ($contacto->HORA_CONTACTO); ?></td>
                                <td ><?php echo ( $contacto->NOMBRE_TIPOLUGAR ); ?> <?php echo ( $contacto->NOMBRE_LUGAR ); ?></td>
                                <td ><?php echo ( $contacto->EDAD_CONTACTO); ?></td>
                                <td ><?php echo ( $contacto->SEXO_CONTACTO); ?></td>
                                ...
                                <td ><?php echo ( $contacto->TITULO_TEMA); ?></td>   
                                <td ><?php echo ( $contacto->NOMBRE_CENTROSERVICIO); ?></td>   
                                <td ><?php echo ( $contacto->NUM_FOLLETOS); ?></td>   
                                <td ><?php echo ( $contacto->NUM_CONDONES); ?></td>   
                                <td ><?php echo ( $contacto->NUM_LUBRICANTES); ?></td>                                
                            </tr>
                            <?php
                        endforeach;
                    }
                    ...
                    foreach ($datosRegistroSemanal->SOPORTES as $archivos) :
                        ...
                        <div class="span2">
                            <div class="block block-themed themed-default">
                                <div class="block-title"><h4>Archivo: <?php echo basename( $archivos->RUTA_SOPORTE_REGISTROSEMANAL ) ?></h4></div>
