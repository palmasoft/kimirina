...
class centrosserviciossaludModel extends ModelBase {    
   ...
   LEFT JOIN subreceptores
    ...
    public static function todos(){
            $query = self::$sqlBase."where centros_servicios_salud.ACTIVO='SI' ORDER BY  centros_servicios_salud.NOMBRE_CENTROSERVICIO ASC ";
    ...
    public static function todos_filtro($canton="", $provincia = ""){ 
            ...
            $filtro = " WHERE centros_servicios_salud.ACTIVO='SI' ";
            if( $provincia != "" && $canton != "" ){
                $filtro.= " ORDER BY centros_servicios_salud.NOMBRE_CENTROSERVICIO ASC , "
                        . "(centros_servicios_salud.ID_CANTON =".$canton." OR provincias.ID_PROVINCIA =".$provincia.") DESC ";
            }
