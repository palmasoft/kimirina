...
<div class="block  block-themed" >
    <div class="block-title">
        <h4>                
            <small>Actividad de Promoción y Entrega de Insumos: </small> <?php if (isset($promocionInsumos)) echo $promocionInsumos->MOTIVO_ACTIVIDAD_PROMOCION ?>
        </h4>
    ...
    <div class="block-content">      
        ...
        <div class="row-items" >
            ...
            <div class=""  style="width: 33%;margin: 0px;float: left;" >
                ...
                <div class="controls">
                    <h4><?php echo isset($promocionInsumos) ? ($promocionInsumos->CONTACTO_LUGAR) : ''; ?></h4>
                </div>
            </div> 
        </div>   
        <div style="clear: both;"></div>
        ...
        <div style="width: 45%;float: left;text-align: center;padding: 1%;border: inherit; border-top: thin solid; margin: 1%; ">
            ...
            <div class="controls">
                ...
                <div style="width: 25%;float: left;text-align: center;" >  
                    ...
                    <div class="">
                        <h3><?php echo isset($promocionInsumos) ? ($promocionInsumos->NUM_PVVS_ACTIVIDAD_PROMOCION) : ''; ?></h3>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div style="width: 45%;float: left;text-align: center;padding: 1%;border: inherit; border-top: thin solid; margin: 1%; " >
            ...
            <div class="controls">
                ...
                <div style="width: 33%;float: left;text-align: center;">
                    <label class="" for="piezascomunicativas" style="">Piezas Comunicativas:</label>
                    <div class="">
                    ...
                    foreach ($promocionInsumos->SOPORTES as $archivos) :
                        ...
                        <div id="soporte_<?php echo intval($archivos->ID_SOPORTE_ACTIVIDAD_PROMOCION) ?>" class="span3" >
                            <div class="block block-themed themed-default">
                                <div class="block-title">
                                    <h4> <?php echo basename( $archivos->RUTA_SOPORTE_ACTIVIDAD_PROMOCION ) ?></h4>
                                </div>
