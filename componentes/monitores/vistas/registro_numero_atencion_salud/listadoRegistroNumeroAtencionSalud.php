...
<div id="page-content">
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right"> 
            <a href="javascript:abrir_ver_datos_registro_numero_atencion();" data-toggle="tooltip" title="Mostrar Formulario" class="btn btn-lg btn-info"><i class="icon-eye-open"></i>Ver</a>
            <a href="javascript:mostrar_formulario_editar_numero_atencion_salud()" data-toggle="tooltip" title="Editar Formulario" class="btn btn-lg btn-warning"><i class="icon-pencil"></i>Editar</a>
            <a href="javascript:eliminar_numero_atencion_salud()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
