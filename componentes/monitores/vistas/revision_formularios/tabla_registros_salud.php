    ...
    <thead>
        <tr>
            <?php if ($SubReceptor->ID_SUBRECEPTOR === 0): ?>
                <th class="">SR</th>
            <?php endif; ?>
            <th class=" text-center">UNIDAD DE SALUD</th>
            ...
            <th class=" hidden-phone">REVISIÓN</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        if (!empty($AtencionesSalud)) {
            foreach ($AtencionesSalud as $atencion_salud) {
                ...
                <tr fila-id="<?php echo $atencion_salud->ID_ATENCION_SALUD ?>" data-num-atencion_salud="<?php echo $atencion_salud->FECHA_ATENCION ?>-<?php echo $atencion_salud->CODIGO_UNICO_PERSONA ?>"  >
                    <?php if ($SubReceptor->ID_SUBRECEPTOR === 0): ?>
                        <th class=""><?php echo ($atencion_salud->SIGLAS_SUBRECEPTOR) ?></th>
                    <?php endif; ?>
...
<script>
    ...
    function abrir_modal_registro_atencion_salud() {
        ...
        if (idRegistro != null) {
            ejecutarAccion('monitores', 'registroAtencionSalud', 'mostrar_datos_registro_atencion_modal', 'id_atencion_salud=' + idRegistro,
