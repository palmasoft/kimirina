...
<div id="pre-page-content">
    <h1>
        <i class="icon-user themed-color"></i> Formulario de Usuario<br>
            ...
            <div class="block-content"> 
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                                        ...
                                        <select name="idPersona" id="idPersona" class="select-chosen">
                                            ...
                                            if (isset($datosUsuario)) {
                                                foreach ($personas as $per) {
                                                    ...
                                                    echo ('<option value="' . $per->ID_PERSONA . '" ' . $selected . ' >' . $per->SIGLAS_SUBRECEPTOR . '-' . $per->NOMBRE_REAL_PERSONA . '-' . $per->IDENTIFICACION_PERSONA . '</option>');
                                                }
                                            }
                                            ?>
                                        </select>
                        ...
                        <div class="control-group">
                            <label class="control-label  span2" for="nick" >Nombre de usuario</label>
                        ...
                        <div class="control-group">
                            <label class="control-label  span2" for="password" >Clave</label>
                            <div class="controls  span10">
...
<?php if (isset($datosUsuario)): ?>
    agregar_boton_ayuda('EDITARUSUARIO');
<?php else: ?>
    agregar_boton_ayuda('NUEVOUSUARIO');
<?php endif; ?>
</script>