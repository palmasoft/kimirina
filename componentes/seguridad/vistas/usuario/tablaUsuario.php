...
<div id="pre-page-content">
    <h1>
        <i class="icon-user themed-color"></i>Usuarios<br>
        <small>Todos los usuarios y contraseñas asociadas a una persona del proyecto para el sistema</small>
    </h1>
</div>
...
<script>
    agregar_boton_ayuda('LISTAUSUARIOS');
</script>