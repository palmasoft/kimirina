...
class usuarioControlador extends ControllerBase {
    ...
    function eliminar_usuario() {
        ...
        if ($objUsuario->ESTADO == 'ACTIVO') {
            ...
            if ($idUsuarioDesactiva > 0) {
                echo '{"resultado":"EXITO", "mensaje":"Registro Activado Exitosamente"}';
            } else {
                echo '{"resultado":"ERROR", "mensaje":"No se ha podido activar. Intentelo nuevamente y si elproblema persite consulte al administrador del sistema."}';
            }
