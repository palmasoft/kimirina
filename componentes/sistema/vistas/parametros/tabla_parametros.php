...
<div id="pre-page-content">
    <h1>
        <i class="icon-gear themed-color"></i>Parámetros<br>
        <small>Listado de Parámetros en el sistema.</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Parametros</a></li>
    </ul>
    <!-- END Breadcrumb -->
...
<script>
    agregar_boton_ayuda('PARAMETROS');
</script>
