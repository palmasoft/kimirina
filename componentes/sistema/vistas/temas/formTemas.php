...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-notes_2 themed-color"></i> Temas en Prevencion y Salud<br>
        <small>Formulario de registros de temas</small>
    </h1>
</div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12"> 
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls span10">
                                <textarea id="instruccionesTema" name="instruccionesTema" class="span12" rows="13" ><?php echo isset($tema) ? ($tema->INSTRUCCIONES_TEMA) : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
<?php if (isset($tema)): ?>
    agregar_boton_ayuda('EDITARTEMASISTEMA');
<?php else: ?>
    agregar_boton_ayuda('NUEVOTEMASISTEMA');
<?php endif; ?>
</script>