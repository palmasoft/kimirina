...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-hospital_h themed-color"></i> Tipo de Unidades de Salud<br>
        <small>Listado de tipos de unidades o centros de atencion en salud.</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Tipos de unidades de Salud</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:confirmar_eliminar_tipo_centros_salud()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
    ...
    <div class="block-section">
        <table id="tipos_centro_de_salud-datatables" class="table table-bordered table-hover dataTables">
            ...
            <tbody>
                <?php foreach ($TiposCentrosSalud as $tipoCentroDeSalud) { ?>
...
<script>
    ...
    function confirmar_eliminar_tipo_centros_salud() {
        var tabla = $('#tipos_centro_de_salud-datatables').dataTable();
        var idFila = filaId(tabla);
        //alert(idFila);
        if (idFila != null) {
            ...
            confirm('¿Seguro que desea eliminar el tipo de unidad de salud <strong>' + nameTipo + '<strong>?', 'eliminar_tipo_centros_salud();')
        } else {
            alert('Seleccione un registro');
        }
...
<script>
    agregar_boton_ayuda('LISTATIPOUNIDADES');
</script>