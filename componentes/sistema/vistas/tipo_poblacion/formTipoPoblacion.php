...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:abrir_tipo_pemar();">Tipos de Poblacion</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        ...
        <div class="block-content">
            <form id="form-pemar" method="POST" onsubmit="return false;">
                ...
                <div class="control-group form-horizontal">
                    ...
                    <div class="controls">
                        <input readonly="" style="width: 100%" type="text" name="codigoTipoPemar" class=" mayusculas sinEspacio " value="<?php echo isset($TipoPemar) ? ($TipoPemar->CODIGO_TIPOPOBLACION) : ''; ?>" required=""><br>
                    </div>
                </div>
                ...
                <div class="control-group form-horizontal" style="display: none;">
                    <label class="control-label" for="general-themed-checkbox">Mostrar en la WEB ( ponteonce.org )</label>
                    <div class="controls">
                        <?php if (isset($TipoPemar) && ($TipoPemar->MOSTRAR_WEB == 'SI')) {
                            $sw = 1;
                        } ?>
...
<script>
<?php if (isset($TipoPemar)): ?>
    agregar_boton_ayuda('EDITARTIPOPEMAR');
<?php else: ?>
