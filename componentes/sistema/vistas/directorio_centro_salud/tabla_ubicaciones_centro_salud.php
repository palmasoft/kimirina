...
<div id="pre-page-content">
    <h1>
        <i class="icon-hospital themed-color"></i>Unidades de Salud<br>
        <small>Listado de Unidades de Salud Registrados en el Sistema.</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Unidades de Salud</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:confirmar_eliminar_centro_servicio()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
...
<script>
    ...
    function confirmar_eliminar_centro_servicio() {
        ...
        if (idFila != null) {
            ...
            confirm('¿Seguro que desea eliminar la Unidad de Salud <strong>' + nameTipo + '</strong> ?', 'eliminar_centro_servicio();');
        } else {
            alert('Seleccione un registro');
        }
...
<script>
    agregar_boton_ayuda('LISTAUNIDADESSALUD');
</script>