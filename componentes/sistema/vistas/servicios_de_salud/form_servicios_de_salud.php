        ...
        <div class="block-content">  
            ...
            <form id="form-ServicioDeSalud" class="form-horizontal" onsubmit="return false;" >       
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="codigoServicioDeSalud" placeholder="Codigo" value="<?php echo isset($servicioSalud) ? ($servicioSalud->CODIGO_SERVICIO) : ''; ?>" class="required sinEspacio mayusculas" required="required"/>
...
<script>
<?php if (isset($servicioSalud)): ?>
    agregar_boton_ayuda('EDITARSERVICIOSALUD');
<?php else: ?>
    agregar_boton_ayuda('NUEVOSERVICIOSALUD');
<?php endif; ?>
</script>
