<div id="pre-page-content">
    <h1>
        <i class="icon-medkit themed-color"></i> Servicios de salud<br>
        <small>Listado de Servicios de Salud</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Servicios de Salud</a></li>
    </ul>
    <!-- END Breadcrumb -->
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:confirmar_eliminar_servicios_salud()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
    <!--    
...
<script>
    ...
    function confirmar_eliminar_servicios_salud() {
        var tabla = $('#tblServiciosSalud').dataTable();
        var idFila = filaId(tabla);
        //alert(idFila);
        if (idFila != null) {
            ...
            confirm( '¿Seguro que deseas eliminar el Servicio de Salud <strong>'+nameTipo+'</strong> ?', 'eliminar_servicios_salud();');
        } else {
            alert('Seleccione un registro');
        }
...
<script>
    agregar_boton_ayuda('LISTASERVICIOSSALUD');
</script>