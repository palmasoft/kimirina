...
<html class="no-js ie9" lang="en">
   <![endif]-->
<!--[if gt IE 8]><!--> 
<html lang="es-ES" class=" js no-flexbox flexbox-legacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimg/image borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths">
    <!--<![endif]-->
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <!-- Meta Tags -->
        <title>Denuncia Ciudadana Publica de Colombia y el Mundo | tombocorrupto.com | NO al Nuevo Orden Mundial</title>
        <meta name="description" content="Realiza tu denuncia anonimamente que nosotros las hacemos publica por ti. denuncia a policias, politicos, vecinos, lugares, etc...">
        <!-- Mobile Specifics -->
        ...
        <meta property="og:image" content="img/tombo-corrupto.png"/>
        <meta property="og:image" content="img/tombo-corrupto.jpg"/>
    ...
    <body style="display: block;">
        ...
        <div id="home-slider">
            ...
            <div class="slider-text">
                <div id="slidecaption">
                    <div class="slide-content">Brushed</div>
                </div>
            </div>
            <div class="control-nav">
                <a id="prevslide" class="load-item" style="display: inline-block;"><i class="font-icon-arrow-simple-left"></i></a>
                <a id="nextslide" class="load-item" style="display: inline-block;"><i class="font-icon-arrow-simple-right"></i></a>
                <ul id="slide-list" style="margin-left: -42px;">
                            ...
                            <section id="projects" class="isotope" style="position: relative; overflow: hidden; height: 657px;">
                                <ul id="thumbs">
                                    ...
                                    <li class="item-thumbs span3 design isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(0px, 0px, 0px);">
                                        ...
                                        <img src="img/image-01.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 design isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(300px, 0px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-02.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 photography isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(600px, 0px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-03.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 video isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(0px, 219px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-08.jpg" alt="Video">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 photography isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(300px, 219px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-04.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 photography isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(600px, 219px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-05.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 video isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(0px, 438px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-09.jpg" alt="Video">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 design isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(300px, 438px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-06.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                    <!-- Item Project and Filter Name -->
                                    <li class="item-thumbs span3 design isotope-item" style="position: absolute; left: 0px; top: 0px; -webkit-transform: translate3d(600px, 438px, 0px);">
                                        ...
                                        <!-- Thumb Image and Description -->
                                        <img src="img/image-07.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                                    </li>
                                    <!-- End Item Project -->
                                </ul>
                            </section>
                ...
                <div class="row">
                    ...
                    <div class="span4 profile">
                        <div class="images-wrap">
                            ...
                            <img src="img/profile-01.jpg" alt="John Doe">
                        </div>
                    ...
                    <div class="span4 profile">
                        <div class="images-wrap">
                            ...
                            <img src="img/profile-02.jpg" alt="Jane Helf">
                        </div>
                    ...
                    <div class="span4 profile">
                        <div class="images-wrap">
                            ...
                            <img src="img/profile-03.jpg" alt="Joshua Insanus">
                        </div>
                    ...
                    <div class="span9">
                        <form id="contact-form" class="contact-form" action="#">
                            <p class="contact-name">
                                <input id="contact_name" type="text" placeholder="Full Name" value="" name="name" class="input-form" >
                            </p>
                            <p class="contact-email">
                                <input id="contact_email" type="text" placeholder="Email Address" value="" name="email" class="input-form" >
                            </p>
                            <p class="contact-message">
                                <textarea id="contact_message" placeholder="Your Message" name="message" rows="15" cols="40"  class="input-form" ></textarea>
                            </p>
                    ...
                    <div class="span12">
                        <nav id="social">
                            <ul>
                                ...
                                <li><a href="https://www.facebook.com/atzenialessio" title="Follow Me on Facebook" target="_blank"><span class="font-icon-social-facebook"></span></a></li>
        ...
        <!-- Footer -->
        <footer>
            <p class="credits">©<?php echo date('Y'); ?> tombocorrupto.com. <a href="#PURO-INGENIO-SAMARIO" title="PURO INGENIO SAMARIO" >PURO INGENIO SAMARIO</a> by <a href="http://www.alessioatzeni.com/" title="Alessio Atzeni | Web Designer &amp; Front-end Developer">Jups Pacvlov</a></p>
        </footer>
        <!-- End Footer -->
        <!-- Back To Top -->
        ...
        <!-- Js -->
        <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script> <!-- jQuery Core -->
        ...
        <script src="js/main.js.php"></script> <!-- Default JS -->
        <!-- End Js -->        
