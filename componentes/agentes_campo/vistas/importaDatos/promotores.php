...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon glyphicon-cloud-upload themed-color"></i> IMPORTACIÓN DE DATOS DESDE ARCHIVOS<br>
        <small>Desde esta funcionalidad usted podrá cargar desde un archivo CVS, los abordajes o alcances de promotores</small>
    </h1>
</div>
...
<br>Las columnas marcadas con * son obligatorias, las demás son opcionales

<br>*Columna 1: Código del Subreceptor: Es llenado con las siglas usadas para el subreceptor elegido, si no las conoce.
<br>*Columna 2: Código del Tipo de Población: Es llenado con las siglas usadas para definir el tipo de población abordada.
...
<br>*Columna 4: Nombre del Cantón donde se realiza el abordaje: Es llenado nombre del canton donde se realizo el abordaje
<br>*Columna 5: Tipo de Lugar donde se realiza el abordaje: Es llenado con el tipo de lugar previamente definido donde se realizó el abordaje
...
<br>Columna 12: Cédula de la persona: Es llenada con el número de documento de identidad de la persona abordada
<br>Columna 13: Número telefónico de la persona: Es llenada con el número telefonico de la persona abordada
<br>Columna 14: Sexo de la persona: Siglas que definen el sexo de la persona, debe ser llenado con su edad en numeros
<br>*Columna 15: Edad de la persona: Edad en números de la persona
...
<br>Columna 17: Fecha de realizacion del abordaje: Día de realización de abordaje, debe ser llenado en formato dd/mm/yyyy
<br>Columna 18: Hora de realización del abordaje: Hora de realización del abordaje, debe ser llenado en formato de hora militar HH:MM
<br>Columna 19: Tipo de alcance: Indica si la persona abordada es nueva o recurrente, debe llenarse de la siguiente manera  N/R
<br>Columna 20: Tema: Es el tipo de información tratada a la persona que se abordó
<br>Columna 21: Cantidad de folletos entregados: Es la cantidad de folletos entregados, debe llenarse con números y si no fueron entregados entonces debe llenarse con cero (0)
<br>Columna 22: Numero de condones entregados: Es la cantidad de condones entregados, debe llenarse con números y si no fueron entregados entonces debe llenarse con cero (0)
<br>Columna 23: Numero de lubricantes entregados: Es la cantidad de lubricantes entregados, debe llenarse con números y si no fueron entregados entonces debe llenarse con cero (0)
...
<br>Columna 25: Fecha de atención: Día de atención en el centro de salud si hubo, debe ser llenado en formato dd/mm/yyyy
<br>Columna 26: Hora de atención: Hora de la atención en el centro de salud si hubo, debe ser llenado en formato de hora militar HH:MM
