            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <div class="control-group">
                        ...
                        <div id="lista-animadores" class="controls">
                            <select id="animador-formulario" name="animador-formulario" class="select-chosen span12">
                                <option value="" >Todos</option>
                                <?php foreach ($Animadores as $animador) { ?>
                                    <?php if ($animador->ID_PERSONA == $Animador) { ?>  
                                        <option data-alias="<?php echo $animador->NOMBRE_OTRO_PERSONA ?>"
                                                value="<?php echo $animador->ID_PERSONA ?>" selected><?php echo ($animador->NOMBRE_REAL_PERSONA) ?></option>
                                            <?php } else { ?>
                                        <option data-alias="<?php echo $animador->NOMBRE_OTRO_PERSONA ?>"
...
<script >
    $(document).ready(function() {
        ...
        $('#monitor-formulario').on('change', function(evt, params) {
            cargar_animadores('lista-animadores', 'animador-formulario', $(this).val());
        });
