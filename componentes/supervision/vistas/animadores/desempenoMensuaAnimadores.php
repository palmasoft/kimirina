...
<div id="pre-page-content">
    <h1><i class="glyphicon-notes_2 themed-color"></i>Desempeño Animadores<br>
...
$(document).ready(function() {
    //
        ...
        $('#form-control-subreceptor-periodo').submit(function(e) {            
            setTimeout(function(){ abrir_desempeno_animadores(); }, 1000);            
        });
...
function generarXLS(){
    ...
    mostrar_contenidos( 
        'supervision', 'desempenoAnimadores', 'accion_generar_xls',$('#form-encabezado-filtros').serialize()       
    ); 
}
</script>
<script>
