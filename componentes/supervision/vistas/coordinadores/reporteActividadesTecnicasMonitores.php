...
<div id="pre-page-content">
    <h1><i class="glyphicon-notes_2 themed-color"></i>Reporte Mensual Actividades Tecnicas del Monitor<br>
        <small>Reporte Mensual Actividades Tecnicas Monitor</small></h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="250">
        ...
        <li class="active"><a href="#">Reporte Actividades Tecnicas del Monitor</a></li>
    </ul>
...
$(document).ready(function() {
        ...
        $('#form-control-subreceptor-periodo').submit(function(e) {            
            setTimeout(function(){ abrir_reporte_actividades_tecnicas_monitor(); }, 1000);            
        });
...
function generarXLS(){
        mostrar_contenidos( 
        'supervision', 'reporteActividadesTecnicasMonitor', 'accion_generar_xls',$('#form-encabezado-filtros').serialize()       
    );  
}
</script>
<script>
