...
//        }
    ...
    public function accion_generar_pdf() {        
        ...
        $datosInforme = $this->datos_del_informe();
       
//        $this->datos['RUTA'] = InformeConsejeriaPares::generar(
//                $this->datos['SubReceptor'], $this->datos['Informe'], PeriodosModel::activo(), 
//                $nombreProvincia, $nombreCanton, $nombreConsejero, 
//                $_SESSION['SESION_USUARIO']->NOMBRE_REAL_PERSONA
//        );
        
        $this->datos['RUTA'] = InformeConsejeriaPares::generar(
                $this->datos['SubReceptor'], $this->datos['Informe'], $periodo, 
                $nombreProvincia, $nombreCanton, $nombreConsejero, 
                $_SESSION['SESION_USUARIO']->NOMBRE_REAL_PERSONA
        );
    ...
    public function accion_generar_xls() {        
        ...
        $this->datos['RUTA'] = InformeConsejeriaPares::generar_xls(
                $this->datos['SubReceptor'], $this->datos['Informe'], $periodo, 
                $nombreProvincia, $nombreCanton, $nombreConsejero, 
                $_SESSION['SESION_USUARIO']->NOMBRE_REAL_PERSONA
        );
    ...
    public function lista_seleccion_consejeros() {
        ...
        echo $this->formularios->Lista_Desplegable(
                $datos, 'NOMBRE_REAL_PERSONA', 'ID_PERSONA', $this->datos['id_lista'], '', ' ', 'cargar_consejeros();', ' select-chosen  ', ' width: 100%; ', false, 'todos', 'consejero-formulario'
        );
    }
