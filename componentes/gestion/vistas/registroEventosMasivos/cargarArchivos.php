            ...
            <div class="span3" id="soporte_<?php echo intval($archivos->ID_SOPORTE_EVENTO_MASIVO) ?>">
                <div class="block block-themed themed-default">
                    <div class="block-title">
                        <h4><a href="javascript:void(0);" class="btn btn-danger enable-tooltip" title="Eliminar Soporte" data-original-title="Eliminar" onclick="confirm('¿seguro que desea eliminar el archivo?', '$(\'#soporte_<?php echo intval($archivos->ID_SOPORTE_EVENTO_MASIVO) ?>\').remove();');" ><i class="icon-trash"></i></a> <?php echo basename( $archivos->RUTA_SOPORTE_EVENTO_MASIVO ) ?></h4>
                    </div>
...
<form class="dropzone form-inline"  >     
    ...
    <div id="pnl_cargar_archivos" >
        <em class="help-block">Todos los formatos son válidos, excepto ejecutables (exe). El tamaño máximo permitido es de 8Mb</em>
        <div class="form-group">
