...
<div id="pre-page-content">
    <h1>
        <i class="fa-ambulance themed-color"></i> Eventos Masivos con Referidos Efectivos<br>
...
<div id="page-content">
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right"> 
            <a href="javascript:ver_evento_masivo();" data-toggle="tooltip" title="Ver Formulario" class="btn btn-lg btn-info"><i class="icon-zoom-in"></i>Ver</a>
...
<script>
    ...
    function ver_evento_masivo() {
        ...
        if (idFila != null) {
            ...
            alert('Debe seleccionar un evento para ver más detalles');
        }
    }
...
<script>
    agregar_boton_ayuda('LISTAEVENTOSMASIVOS');
</script>