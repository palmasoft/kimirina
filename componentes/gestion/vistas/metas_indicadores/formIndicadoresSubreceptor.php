    ...
    <div class="block block-themed ">
        ...
        <div class="block-title">
            ...
            <div class="block-options" >
                <a href="javascript:abrir_form_nuevas_metas_subreceptor();" data-toggle="tooltip" title="Modificar los valores de las metas semestrales para el subreceptor elejido" class="btn btn-lg btn-success"><i class="icon-pencil"></i> Editar Metas </a>						                
            </div>
        </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <div id="lista-Subreceptores" class="">
                        <select id="subreceptor_indicadores" name="subreceptor_indicadores" class="select-chosen" style="width: 100%;" >
                            <?php
                            foreach ($SubReceptores as $subreceptor) {

                                if ($subreceptor->ID_SUBRECEPTOR == 0) {
                                    continue;
                                }
