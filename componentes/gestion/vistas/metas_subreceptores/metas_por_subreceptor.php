...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:void();">Listado de Metas</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active"><a href="#">Metas del SubReceptor</a></li>
    </ul>
    <!-- END Breadcrumb -->
...
//            } else {
                ejecutarAccionJson(
                        'gestion', 'metasSubreceptores', 'guardar_metas_subreceptor',
                        datosForm, ' mostrar_resultado_guardar( data, "abrir_listado_indicadores_proyecto_subreceptor();", "" );'
                        );
//            }
        ...
        $('.valor_indicador').on('keyup', function(e) {
...
<script>
    agregar_boton_ayuda('CAMBIARMETASSUBRECEPT');
</script>
