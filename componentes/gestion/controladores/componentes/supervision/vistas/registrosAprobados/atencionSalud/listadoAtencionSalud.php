...
<div id="pre-page-content">
    <h1>
        <i class="fa-user-md themed-color"></i> Registros de Atencion en Unidad de Salud Aprobados<br>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:void(0);">Listado</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
