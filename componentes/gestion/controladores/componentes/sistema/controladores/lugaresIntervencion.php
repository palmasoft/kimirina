...
class lugaresIntervencionControlador extends ControllerBase {
    ...
    public function cargar_vista_lugares_intervencion() {
        $this->datos['provincias'] = UbicacionesModel::todas_provincias();
        $this->datos['cantones'] = UbicacionesModel::todos_cantones();
        $this->datos['Tipo'] = TiposLugaresModel::todos();
...
//        $this->datos['datos']->ID_PROVINCIA = $provincia;
//        $this->datos['datos']->ID_CANTON = $canton;
//        $this->datos['datos']->ID_TIPOLUGAR = $tipoLugar;
    ...
    function guardar_nuevo_lugar_intervencion(){
    	$idLugarIntervencion = LugaresIntervencionModel::insertar(
                ...
                $this->datos['cantones'],
                $this->datos['nombreLugar'],
                $this->datos['direccionLugar'],
                $this->datos['telefonoLugar'],
                $this->datos['nombreContacto'],
                $this->datos['telefonoContacto'],
                $this->datos['correoContacto'],
                $this->datos['web'],
