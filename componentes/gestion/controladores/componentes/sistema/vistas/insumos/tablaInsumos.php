...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-cargo themed-color"></i> Listado Insumos<br>
        <small>Todos los Insumos Disponibles</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:eliminar_insumo()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
