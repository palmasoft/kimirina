...
<div id="pre-page-content">
    <h1>
        ...
        <small>Registro de Lugares de Consejería</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:abrir_listado_lugares_consejeria();">Listado Consjerias</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active"><a href="#">Recibo consejeria</a></li>
    </ul>
    <!-- END Breadcrumb -->
        ...
        <form id="form-consejeria" class="form-horizontal" onsubmit="return false;" >       
            <input type="hidden" id="registro-id" name="registro-id" value="<?php echo isset($consejeria) ? ($consejeria->ID_LUGAR_CONSEJERIA) : '' ; ?>" />         
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="codigo_lugar_consejeria" placeholder="Codigo Sin Espacio" value="<?php echo isset($consejeria) ?($consejeria->CODIGO_LUGAR_CONSEJERIA) : '' ; ?>" class="required sinEspacios" required="required"/>
                    </div>
                </div>
                <div class="control-group">
    ...
    //informacion('lo que sea');
        $('#form-consejeria').submit(function() {
            ...
            if( estaVacio( $('#registro-id').val() )  ){
                ejecutarAccionJson( 'sistema', 'lugaresConsejerias', 'guardar_nuevo_lugar_consejeria', datosForm, 'mostrar_resultado_guardar( data, "abrir_listado_lugares_consejeria();", "" );' );
            }else{
                ejecutarAccionJson(
