...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:tabla_subreceptor_provincia();">Listado</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active"><a href="#">Subreceptores en Provincias</a></li>
    </ul>
    <!-- END Breadcrumb -->
