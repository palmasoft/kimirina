...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-search themed-color"></i> PEMARS(Personas de Mayor Riesgo)<br>
        <small>Consulta de las Personas de Mayor Riesgo al sistema</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Consulta PEMARS</a></li>
    </ul>
    <!-- END Breadcrumb -->
        ...
        <div class="block-content"> 
            ...
            <form id="form-pemars-arv" class="form-horizontal" onsubmit="return false;" >                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" maxlength="12" id="codigo-pemar-generado" name="codigopersona" placeholder="Codigo Sin Espacio" value="<?php echo isset($pemar) ? ($pemar->CODIGO_UNICO_PERSONA) : ''; ?>" class="required sinEspacio" required="required"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" maxlength="10" id="cedula-atendido" name="ci_poblacion" placeholder="cedula" 
    ...
    <div id="resultado_busqueda" class="block-content" >
        <?php $this->mostrar("pemars/consulta_tabla_permars", $this->datos) ?>
    </div>    
