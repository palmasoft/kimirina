...
<div id="pre-page-content">
    <h1>
        ...
        <small>Listado de Personas de Mayor Riego registrados en el sistema.</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="#">Parametros</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active"><a href="#">Esquemas PEMARS</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:eliminar_pemar()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
