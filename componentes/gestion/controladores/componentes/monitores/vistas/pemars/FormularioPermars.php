...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-user themed-color"></i> PEMARS (Personas de Mayor Riesgo)<br>
        <small>Registro de las Personas de Mayor Riesgo al sistema</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:abrir_listado_pemars();">Formatos</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        ...
        <div class="block-content"> 
            ...
            <form id="form-pemars-arv" class="form-horizontal" onsubmit="return false;" >                
                ...
                <div class="control-group">
                    <label class="control-label" for="id_tipo_poblacion">ID Tipo Poblacion</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" for="codigopersona">Codigo unico de Persona</label>
                    <div class="controls">
                        <input type="text" id="codigo-pemar-generado"name="codigopersona" placeholder="Codigo Sin Espacio" value="<?php echo isset($pemar) ? ($pemar->CODIGO_UNICO_PERSONA) : ''; ?>" class="required sinEspacio" required="required" readonly/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <label class="control-label" for="ci_poblacion">Cedula</label>
                    <div class="controls">
                        <input type="text" id="cedula-atendido" name="ci_poblacion" placeholder="cedula"  value="<?php echo isset($pemar) ? ($pemar->CI_POBLACION) : ''; ?>" class="required sinEspacio" required="required"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <label class="radio" for="radio_masculino">
                            <input type="radio" id="radio_masculino" name="sexo-radios" value="HOMBRE" <?php if (isset($pemar)) echo $pemar->SEXO == 'HOMBRE' ? 'checked="checked"' : ''; ?> required >Masculino
                        </label>
                        <label class="radio" for="radio_femenino">
                            <input type="radio" id="radio_femenino" name="sexo-radios" value="MUJER" <?php if (isset($pemar)) echo $pemar->SEXO == 'MUJER' ? 'checked="checked"' : ''; ?> required> Femenino
                        </label>
                        <label class="radio" for="radio_transexual">
                            <input type="radio" id="radio_transexual" name="sexo-radios" value="TRANS" <?php if (isset($pemar)) echo $pemar->SEXO == 'TRANS' ? 'checked="checked"' : ''; ?> required > Transexual
                        </label>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success"><i class="icon-ok"></i> Aceptar</button>
                </div>
                <!-- END Form Buttons -->
            </form>
    ...
    $(document).ready(function() {
        ...
        $('#form-pemars-arv').submit(function() {
            ...
            if (estaVacio($('#registro-id').val())) {
                ...
                ejecutarAccionJson('monitores', 'pemars', 'guardar_nueva_pemar', datosForm, 'mostrar_resultado_guardar( data, "abrir_listado_pemars();", "" );');
            } else {
                ejecutarAccionJson(
