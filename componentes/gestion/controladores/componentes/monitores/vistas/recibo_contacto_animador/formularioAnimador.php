            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="control-group">                    
                        ...
                        <div class="controls" >
                            <input type="number" id="num_recibo" required="" value="<?php echo isset($datosContactoAnimador) ? ($datosContactoAnimador->NO_RECIBO_CONTACTOANIMADOR) : str_pad($NoRecibo + 1, 9, '0', STR_PAD_LEFT); ?>" name="num_recibo" class="span8" placeholder="000000000" style="color: #ff0000;font-weight: bold;" />
                        ...
                        <div class="controls ">
                            <select id="tipo_pemar" name="tipo_pemar" class=" select-chosen span12 required"  >
                                ...
                                foreach ($TiposPemars as $tipoPemar):
                                    ...
                                    ?>
                                    <option value="<?php echo $tipoPemar->ID_TIPOPOBLACION ?>"  data-max-condones="<?php echo $tipoPemar->MAXIMO_CONDONES ?>" data-max-lubricantes="<?php echo $tipoPemar->MAXIMO_LUBRICANTES ?>" <?php echo $selected ?> title="<?php echo ($tipoPemar->CODIGO_TIPOPOBLACION) ?>" data-cod="<?php echo ($tipoPemar->CODIGO_TIPOPOBLACION) ?>">[<?php echo ($tipoPemar->CODIGO_TIPOPOBLACION) ?>] <?php echo ($tipoPemar->NOMBRE_TIPOPOBLACION) ?></option>
                                <?php endforeach; ?>                                     
                            </select>                        
                        </div>         
                    </div>
            ...
            <div class="block block-themed">
                ...
                <div class="block-content"> 
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span2" style="<?php if ($_SESSION['SESION_USUARIO']->ID_ROL == 8): ?> display: none; <?php endif; ?>" >
                            ...
                            <div class="span9" >                            
                                <div class="control-group">
                                    ...
                                    <div class="controls  span6 ">
                                        <input type="number" id="cantidad-condones-entregados-contacto" name="noCondones" min="0"  readonly="" max="<?php if (isset($datosContactoAnimador->NUM_CONDONES)) echo $datosContactoAnimador->NUM_CONDONES; ?>" 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls  span6 ">
                                        <input type="number" id="cantidad-lubricantes-entregados-contacto" name="noLubricantes" min="0" readonly=""  max="<?php if (isset($datosContactoAnimador->NUM_LUBRICANTES)) echo $datosContactoAnimador->NUM_LUBRICANTES; ?>" 
