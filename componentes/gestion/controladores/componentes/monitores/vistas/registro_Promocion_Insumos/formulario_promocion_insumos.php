...
<div class="block  block-themed" >
    <div class="block-title">
        <h4>
            ...
            Actividad de Promocion y Entrega de Insumos 
        </h4>
        ...
        <form id="form-promocion_insumos" class="form-horizontal" onsubmit="return false;" >
                    ...
                    <div class="" style="width: 50%;margin: 0px;float: left;">
                        ...
                        <div class="">
                            <select id="tipo_lugar_intervencion_contacto" name="tipo_lugar_intervencion_contacto" class="select-chosen cambiar_lugar_intervencion_contacto"  style="width: 100%;" >
                                <option value="" data-codigo="" >Selecciones tipo Lugar</option>
                                <?php
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <div style="width: 30%;float: left;text-align: center;">
                        <label class="" for="lubricantes">Lubricantes Entregadas</label>
                        <div class="">
    ...
    <div class="form-actions">
        <button id="btn_limpiar_promocion_insumos" type="reset" class="btn btn-danger"><i class="icon-repeat"></i> Limpiar</button>
        <button id="btn_guardar_promocion_insumos" type="submit" class="btn btn-success"><i class="icon-ok"></i> Guardar</button>
    </div>
    <!-- END Form Buttons -->
</div>   
