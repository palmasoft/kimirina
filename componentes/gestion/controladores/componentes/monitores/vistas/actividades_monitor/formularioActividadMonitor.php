...
<div class="block block-themed block-last">
    <div class="form-actions text-center">
        <button id="btn_eliminar_actividad" type="reset" class="btn btn-danger"><i class="icon-repeat"></i> Limpiar</button>
        <button id="btn_guardar_actividad" type="submit" class="btn btn-success"><i class="icon-ok"></i> Guardar</button>
    </div>
</div>
