...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-notes_2 themed-color"></i> Actividades del Monitor<br>
        <small>Actividad del Monitores</small>
    </h1>
</div>
                ...
                <div class="block-content"> 
                    <div class="row-fluid">
                        ...
                        <div style="clear: both;" >                        
                            ...
                            <div class="span6">
                                <label class="control-label  span4" >Canton:</label>
                                <div class="controls  span8">                            
                ...
                foreach ($datosActividad->SOPORTES as $archivos) :
                    ...
                    <div class="span3" id="soporte_<?php echo intval($archivos->ID_SOPORTE_ACTIVIDAD_MONITOR) ?>">
                        <div class="block block-themed themed-default">
                            <div class="block-title">
                                <h4> Archivo <?php echo intval($archivos->ID_SOPORTE_ACTIVIDAD_MONITOR) ?>: <?php echo $archivos->TIPO_SOPORTE_ACTIVIDAD_MONITOR ?></h4>
                            </div>
