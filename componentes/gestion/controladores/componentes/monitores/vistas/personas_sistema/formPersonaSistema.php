...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-user themed-color"></i> Personas del Sistema<br>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="javascript:abrir_listado_personas_sistema();">Listado Personas</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
        <li class="active"><a href="#">Integrantes proyecto</a></li>
    </ul>
    <!-- END Breadcrumb -->
        ...
        <div class="block-content"> 
            ...
            <form id="form-personas-sistema" class="form-horizontal" onsubmit="return false;" >
                    ...
                    <div id="lista-provincia" class="controls">
                        <select id="provincia-chosen" name="provincia-chosen" class="select-chosen" size="1">
                            ...
                            foreach ($provincias as $provincia) { 
                                 $selected = "";
                                if (isset($personaSistema))
                                    if ($personaSistema->ID_PROVINCIA == $provincia->ID_PROVINCIA)
                                        $selected = "selected";
                                ?>
                    ...
                    <div id="listado-cantones" class="controls">
                        <select id="cantones" name="cantones" class="select-chosen"  size="1">
                            ...
                            foreach ($cantones as $canton) {
                                $selected = "";
                                if (isset($personaSistema))
                                    if ($personaSistema->ID_CANTON == $canton->ID_CANTON)
                                        $selected = "selected";
                                ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="fechaNacimiento" name="fechaNacimiento"  value="<?php echo isset($personaSistema) ? ($personaSistema->FECHA_BIRTH_PERSONA) : ''; ?>" class="input-small input-datepicker">
