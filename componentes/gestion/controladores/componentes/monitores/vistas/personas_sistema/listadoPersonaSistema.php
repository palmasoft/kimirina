...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-table themed-color"></i> Personas Sistema<br>
        <small>Todos las personas registradas en el sistema</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Personas en el sistema</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:eliminar_personas_sistema()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>
        ...
        <table id="tblPersonasSistema" class="table table-bordered table-hover dataTables" >
            ...
            <tbody>                
                <?php foreach ($PersonasSistema as $persona) : ?>                
                    <tr fila-id="<?php echo ($persona->ID_PERSONA) ?>" data-nombre="<?php echo ($persona->NOMBRE_REAL_PERSONA) ?>">
