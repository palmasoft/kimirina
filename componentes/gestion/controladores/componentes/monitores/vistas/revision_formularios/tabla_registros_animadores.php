        ...
        if (!empty($ContactoAnimador)) {
            foreach ($ContactoAnimador as $contactoAnimador) {
                ...
                <tr fila-id="<?php echo $contactoAnimador->ID_CONTACTOANIMADOR ?>" data-titulo="<?php echo ($contactoAnimador->NO_RECIBO_CONTACTOANIMADOR) ?>">
                    ...
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->TIPO_FORMATO_CONTACTOANIMADOR) ?></td>
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->NOMBRE_PROVINCIA) ?> - <?php echo ($contactoAnimador->NOMBRE_CANTON) ?></td>
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->CODIGO_UNICO_PERSONA) ?></td>
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->CEDULA_PEMAR) ?></td>
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->PRIMER_NOMBRE_PEMAR . ' ' . $contactoAnimador->SEGUNDO_NOMBRE_PEMAR . ' ' . $contactoAnimador->PRIMER_APELLIDO_PEMAR . ' ' . $contactoAnimador->SEGUNDO_APELLIDO_PEMAR) ?></td>
                    <td class="hidden-xs hidden-sm"><?php echo ($contactoAnimador->TITULO_TEMA) ?></td>
...
<script>
    ...
    function abrir_modal_registro_animadores() {
        ...
        if (idRegistro != null) {
            ejecutarAccion('monitores', 'reciboContactoAnimador', 'mostrar_datos_contacto_animador', 'idReciboAnimador=' + idRegistro,
