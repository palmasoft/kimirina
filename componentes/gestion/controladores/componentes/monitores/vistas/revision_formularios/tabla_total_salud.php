<table id="tbl-form-registros-animadores" class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td class="text-center"><?php echo $totalAtencionSalud->TOTAL_PENDIENTES ?></td>
            <td class="text-center"><?php echo $totalAtencionSalud->TOTAL_ENREVISION ?></td>
            <td class="text-center"><?php echo $totalAtencionSalud->TOTAL_REVISADOS ?></td>
            <td class="text-center"><?php echo $totalAtencionSalud->TOTAL_APROBADOS ?></td>
        </tr>
...
<script>
    ...
    function revisar_todos_atencion_salud() {
        confirm('Desea cambiar a estado <strong>REVISADO</strong> todos los registros de Atencion en Salud? para este periodo', 'revisarRegistroAtencionSalud()');
    }
