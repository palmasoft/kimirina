...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-user themed-color"></i> Consejeria PVVS<br>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">                        
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls  span8">
                            <?php echo $datosConsejeria->NOMBRE_LUGAR_CONSEJERIA; ?> 
                        </div>
                    </div>
<!--
                    <div class="control-group">
...
<!--                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label class="control-label  span4" for="idEstablecimiento">Establecimeinto donde recibe atención:</label>
                        <div class="controls  span8">
                    ...
                    foreach ($datosConsejeria->SOPORTES as $archivos) :
                        ...
                        <div class="span2">
                            <div class="block block-themed themed-default">
                                <div class="block-title"><h4>Archivo: <?php echo $archivos->TIPO_SOPORTE_CONSEJERIA ?></h4></div>
