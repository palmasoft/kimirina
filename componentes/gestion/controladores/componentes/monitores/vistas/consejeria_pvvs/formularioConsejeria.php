            ...
            <div class="row-fluid">
                ...
                <div class="span6">                        
                    <div class="control-group">
                        ...
                        <div class="controls span8">
                            <input type="text" maxlength="2" title="Dos primeras letras del primer nombre" id="dosPrimerNombre" name="dosPrimerNombre" 
                            ...
                            <input type="text" maxlength="2" title="Dos primeras letras del segundo nombre" id="dosSegundoNombre" name="dosSegundoNombre" 
                                   class=" span1 soloLetras validar_cedula_codigo mayusculas " style="width: 30px;"  
                                   value="<?php if (isset($datosConsejeria)) echo substr($datosConsejeria->SEGUNDO_NOMBRE_PEMAR, 0, 2) ?>" > 
                            <input type="text" maxlength="2" title="Dos primeras letras del primer apellido" id="dosPrimerApellido" name="dosPrimerApellido" 
                                   class=" span1 soloLetras validar_cedula_codigo mayusculas " style="width: 30px;"  
                                   value="<?php if (isset($datosConsejeria)) echo substr($datosConsejeria->PRIMER_APELLIDO_PEMAR, 0, 2) ?>">      
                            <input type="text" maxlength="2" title="Dos primeras letras del segundo apellido" id="dosSegundoApellido" name="dosSegundoApellido" 
                                   class=" span1 soloLetras validar_cedula_codigo mayusculas " style="width: 30px;"  
                        ...
                        <!--
                        <div class="controls  span8">
                            <input type="text" id="codigoUsuario" name="codigoUsuario" class="required" required="required" >
                        </div>
                        -->
                        <!-- <span class="help-block">(2 primeras letras del primer nombre, 2 primeras letras del primer apellido y año de nacimiento)</span> -->
                    </div> 

                    <div class="control-group">
                        <label class="control-label  span4" for="cedulaUsuario">Cedula o DNI:</label>
                        <div class="controls  span8">
                            <input type="text" maxlength="10" id="cedulaUsuario" name="cedulaUsuario" class="validar_cedula_codigo sinEspacio" required="" 
                    ...
                    <div class="control-group" style="display: none">
                        <label class="control-label  span4" for="tiempoAno">Tiempo que sabe su diagnostico</label>
                        <div class="controls  span8">
                ...
                <div class="span6">                       
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls  span8">
                            <input type="number" id="nroCondones" name="nroCondones" class="insumos-entregados" min="0" readonly=""
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls  span8">
                            <input type="number" id="nroLubricantes" name="nroLubricantes" class="insumos-entregados" min="0" required="" readonly=""   
                    ...
                    <div class="control-group">    
                        <label class="control-label  span4" for="idLugar">Lugar de la consejeria:</label>
                        <div class="controls  span8">
