...
<div id="pre-page-content">
    <h1><i class="glyphicon-notes_2 themed-color"></i>Registro Semanal de Alcances <?php echo $tipoPoblacion; ?><br><small>Formulario de formatos de registro semanal de alcances con TRANS!</small></h1>
</div>
...
<div id="page-content">
    ...
    <form id="form-registro-semanal-contactos" method="post" class="form-inline" onsubmit="return false;"> 
        ...
        <input type="hidden" name="tipo_poblacion" value="3" />
