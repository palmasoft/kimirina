    ...
    function agregar_recibo_contacto_animador() {
        ...
        if ($idPemar <= 0) {
            $idPemar = PemarsModel::insertar_con_sexo_sin_correo(
                            $this->datos['tipo_pemar'], $this->datos['sel-lista-cantones'], $this->datos['codigo-pemar'], $this->datos['mes-nacimiento'], $this->datos['ano-nacimiento'], $SEXO, $this->datos['primer_nombre'], $this->datos['primer_apellido'], $this->datos['segundo_nombre'], $this->datos['segundo_apellido'], $this->datos['otro_nombre_contacto'], '', $this->datos['telefono_contacto']
            );
        }
