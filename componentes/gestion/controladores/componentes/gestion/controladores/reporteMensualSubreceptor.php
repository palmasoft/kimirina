...
class reporteMensualSubreceptorControlador extends ControllerBase {
    ...
    public function pre_aprobar_informe_mensual() {
        ...
        if ($this->datos['estaPreAprobadoPeriodo']) {
            ReporteMensualSubreceptorModel::actualiza_pre_aprobar_periodo_subreceptor($idSubreceptor, $idPeriodo);
        } else {
            ReporteMensualSubreceptorModel::pre_aprobar_periodo_subreceptor($idSubreceptor, $idPeriodo);
        }
...
//            $insumo_cantidad = 0;
//            $insumo_cantidad += 
//                    IndicadoresModel::calcula_todos_promotores_insumos($idPeriodo, $idSubreceptor, $insumo->ID_INSUMO) + 
//                    IndicadoresModel::calcula_todos_animadores_insumos($idPeriodo, $idSubreceptor, $insumo->ID_INSUMO) + 
//                    IndicadoresModel::calcula_PVVS_consejeros_insumos($idPeriodo, $idSubreceptor, $insumo->ID_INSUMO);
//            InsumosModel::updateStockResta($insumo->ID_INSUMO, $insumo_cantidad);
//        }
////        $this->mostrar_informe_mensual_coordinador();
//        $this->mostrar_informe_mensual_gestor();
    }
