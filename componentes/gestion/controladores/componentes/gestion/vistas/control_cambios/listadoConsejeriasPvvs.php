...
<div id="page-content">
    ...
    <div class="row-fluid botones_arriba" style="text-align: center;" >
        ...
        <div class="span4 btn-group text-right">
            ...
            <a href="javascript:abrir_ver_datos_consejeria();" data-toggle="tooltip" title="ver Contactos " class="btn btn-lg btn-info"><i class="icon-angle-right"></i>Ver</a>
...
//        alert(idFila);
    ...
    function abrir_cambios_del_registro_aprobado() {
        ...
        if (idFila != null) {
            ejecutarAccion(
                    'gestion', 'auditoriaFormularios', 'correcciones_consejeria_aprobado',
