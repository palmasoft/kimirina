...
<div id="pre-page-content">
    <h1><i class="glyphicon-table themed-color"></i> Hojas de Registro Semanal de Alcances Aprobadas<br />
        <small>registra los formularios de alcances del promotor!</small></h1>
</div>
...
<script>
    ...
    function abrir_editar_registro_aprobado() {
        ...
        if (idFila != null) {
            mostrar_contenidos(
                    'supervision', 'auditoriaFormularios', 'editar_formulario_registro_semanal_aprobado', 'idRegistroSemanal=' + idFila
                    );
        } else {
            alert('Seleccione un registro');
        }
