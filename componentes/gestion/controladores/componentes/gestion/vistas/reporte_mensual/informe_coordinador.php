...
<div id="pre-page-content">
    <h1>
        <i class="icon-check themed-color"></i> Reporte Mensual Coordinadores<br>
        <small>Ventana de Aprobacion de Reporte Mensual y Generacion de Reporte de Periodo.</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li class="active"><a href="#">Reporte Mensual de Coordinadores</a></li>
    </ul>
    <!-- END Breadcrumb -->
