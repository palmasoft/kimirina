...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-notes_2 themed-color"></i> Reporte Mensual de Subreceptor<br>
        <small>Ventana de Aceptacion de Informe Mensual y Generacion de Reportes de Periodo.</small>
    </h1>
</div>
                    ...
                    <?php if (!$estaAceptadoPeriodo) { ?> 
                        ...
                        <?php } else { ?>
                            <?php if ($estaPreAprobadoPeriodo) { ?>
                                <button id="" type="button" class="btn btn-danger"><i class="icon-cancel"></i> NO ESTA APROBADO </button> 
                                <button id="btn_descarga_ultimo_reporte" type="button" class="btn btn-success"><i class="icon-download-alt"></i> Ver Reporte Generado</button>
                            <?php } else { ?>
