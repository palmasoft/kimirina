...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-shopping_bag themed-color"></i> Stock/Existencias de Insumos<br>
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top" data-spy="affix" data-offset-top="205">
        ...
        <li>
            <a href="#">Stock Insumos</a> <span class="divider"><i class="icon-angle-right"></i></span>
        </li>
