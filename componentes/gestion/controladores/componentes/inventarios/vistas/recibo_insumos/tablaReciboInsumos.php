...
<div id="pre-page-content">
    <h1>
        <i class="glyphicon-shopping_cart themed-color"></i> Tabla Insumos Recibidos<br>
        <small>Listado de Insumos recibidos y añadidos</small>
    </h1>
</div>
...
<div id="page-content">
    ...
    <div class=" row-fluid botones_arriba" >
        ...
        <div class=" span4 btn-group text-right">                
            ...
            <a href="javascript:eliminar_recibo_insumos()" data-toggle="tooltip" title="Borrar Formulario" class="btn btn-lg btn-danger"><i class="icon-remove"></i>Eliminar</a>
        </div>
    </div>            
